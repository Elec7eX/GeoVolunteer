...
=======
      ...
      <div className="body">
        ...
        <p>
          ...
          shows that spatial optimization models can be naturally expressed as a
          series of relational tables. This approach is possible due to the
          advancement of spatial databases and the following facts: Location
          analysis is closely linked to GIS. First of all, site analysis relies
          on GIS for a variety of functions from data processing to
          visualization and interpretation of site decisions. Historically, one
          of the primary motivations for the invention of GIS was to support
          site selection and site analysis in a computerized system. Secondly,
          from a broader perspective, site modeling and GIS are both part of
          spatial decision support systems. GIS, with all its data management
          and analysis capabilities, ultimately requires location modeling to
          ...
          shows that spatial optimization models can be naturally expressed as a
          series of relational tables. This approach is possible due to the
          advancement of spatial databases and the following facts:
